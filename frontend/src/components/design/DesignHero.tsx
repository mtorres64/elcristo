...
export function DesignHero({ title, image }: { title: string; image: string }) {
  return (
    <section className="relative min-h-[420px] md:min-h-[520px] flex items-end overflow-hidden">
      ...
      {image ? (
        ...
        <>
          <div className="absolute inset-0 bg-gradient-to-br from-[#5A7A5C] to-[#111810]" />
      ...
      <div className="absolute top-0 left-0 right-0">
        <div className="max-w-screen-xl mx-auto px-6 py-5">
          <nav className="flex items-center gap-2 text-xs text-white/70">
            ...
            <ChevronRight />
            <span className="text-white font-medium">Diseño & Paisajismo</span>
          </nav>
        </div>
      </div>
